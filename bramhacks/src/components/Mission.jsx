  ...
  const items = [
    {
      ...
      subtitle:
        "According to studies, 98% of drivers report being affected by night time glare. Additionaly, 75% of drivers choose to stay off the road do so due to this pressing concern. This contributes to the signifcant increase in light pollution globally, as North American skies get 10% brighter every year. ",
      bullets: [
